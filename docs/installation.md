...
Открытая метрика TeX Gyre Termes используется в контейнере только как запасной
вариант, когда Times New Roman недоступен. Для нормативного PDF добавьте
лицензированный Times New Roman в окружение сборки. DOCX запрашивает Times New
Roman стилями документа и не встраивает шрифт.
